...
/// Autor: Lucas Barboza
/// Data: 03/04/2021
/// Subclasse herdada de Weapon que gerencia os atributos, tiro e recarga da AK47
/// </summary>
public class AK47 : Weapon
{
    private float bulletForce = 10f;                                            // Força da bala da AK47

    //Método responsável por instanciar os projeteis da AK47
    public override void Shoot(Transform firePoint, GameObject bulletPrefab)
    {
        ...
        Rigidbody2D rb = bullet.GetComponent<Rigidbody2D>();                // Obtem o componmente rigidBody do projetil 
