...
public class Shooting : MonoBehaviour
{
    ...
    void Update()
    {
        Weapon currentGun = Weapons.GetComponent<Weapon>();
        GameObject shotPrefab;
        UpdateGunSelection();
        switch (GunType)
        {
            case 1: currentGun = Weapons.GetComponentInChildren<Handgun>(); shotPrefab = bulletPrefab; break;
            case 2: currentGun = Weapons.GetComponentInChildren<Shotgun>(); shotPrefab = pelletPrefab; break;
            ...
            default: currentGun = Weapons.GetComponentInChildren<Handgun>(); shotPrefab = bulletPrefab; break;
        }
